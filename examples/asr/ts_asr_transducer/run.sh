...
#     model.train_ds.manifest_filepath=/home/jovyan/mt-asr-data-prep/manifests/ami/ami-sdm_train_30s_nemo_manifest.jsonl \
#     model.validation_ds.manifest_filepath=/home/jovyan/mt-asr-data-prep/manifests/ami/ami-sdm_train_30s_nemo_manifest.jsonl \
#     model.tokenizer.dir=/tmp/tokenizers/ls960/tokenizer_spe_bpe_v500 \
#     model.tokenizer.type=bpe \
#     trainer.devices=-1 \
#     trainer.accelerator=gpu \
...
#     exp_manager.checkpoint_callback_params.monitor=val/cp_wer \
#     exp_manager.create_wandb_logger=True \
#     exp_manager.wandb_logger_kwargs.name=parakeet_110m_tdtonly_fddt_lr_mul_100_lr2.0_ami_nsf_l2m_30s_nsf_dev_longform_2k_warmup_64bs_v2 \
#     exp_manager.wandb_logger_kwargs.project=dk_nemo_tests \
#     +init_from_pretrained=nvidia/parakeet-tdt_ctc-110m \
#     name=parakeet_110m_tdtonly_fddt_lr_mul_100_lr2.0_ami_nsf_l2m_30s_nsf_dev_longform_2k_warmup_64bs_v2 \
#     +model.decoding.compute_timestamps=True \
#     +model.decoding.preserve_alignments=True
